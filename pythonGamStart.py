#work in progress updated GamStart (All in one GAM script)
import os
import sys
...
print("Python v1.0")
print("Starting...")
result_test = os.popen("/Users/Havens/bin/gam/gam info user jswanton").read()
...
if choice_1:
    ...
    if choice_2:
        ...
        gam_input = "/Users/Havens/bin/gam/gam create user "+NEWUSER+" firstname "+first_name+" lastname "+last_name+" password "+NEWDEFAULTPW+" changepassword off org '/Swanton-All/Swan Staff-All'"
    ...
    if choice_3:
        ...
        NEWEMAIL = NEWUSER + "@fnwsu.org"
        NEWDEFAULTPW = first_name[0].lower() + last_name[0].lower() + "3456789"
        gam_input = "/Users/Havens/bin/gam/gam create user "+NEWUSER+" firstname "+first_name+" lastname "+last_name+" password "+NEWDEFAULTPW+" changepassword off org '/Swanton-All/Swan Students-All/Swan Grade "+str(grade)+"-20"+str(grad_year)+"'"
        result_1 = os.popen(gam_input).read()
        print(result_1)
    ...
    gam_input = "/Users/Havens/bin/gam/gam info user "+NEWUSER
    result_1 = os.popen(gam_input).read()
    print(result_1)
    print()
...
if choice:
    ...
    print("Info:")
    print()
    gam_input = "/Users/Havens/bin/gam/gam info user "+existing_user_name
    result_1 = os.popen(gam_input).read()
    result_2 = result_1
    ...
    for x in group_list:
        gam_input = "/Users/Havens/bin/gam/gam info group "+x
        result_1 = os.popen(gam_input).read()
    ...
    if choice:
        ...
        gam_input = "/Users/Havens/bin/gam/gam update user "+existing_user_name+" password '"+new_password+"' changepassword off"
    ...
    if choice:
        for key in group_dictionary:
            gam_input = "/Users/Havens/bin/gam/gam update group "+key+" remove user "+existing_email
            print(key)
            result = os.popen(gam_input).read()
            print(result)
        gam_input = "/Users/Havens/bin/gam/gam info user "+existing_user_name
        ...
        if choice:
            for key in group_dictionary:
                print(key)
                gam_input = "/Users/Havens/bin/gam/gam update group "+key+" add "+group_dictionary[key]+" user "+existing_email
                result_1 = os.popen(gam_input).read()
                print(result_1)
        else:
    ...
    if choice:
        ...
        if choice:
            ...
            choice = query_yes_no(question, default="yes")
            if choice:
                gam_input= "/Users/Havens/bin/gam/gam update group swantonprofessionalstaff@fnwsu.org add member user "+ existing_email
                result_1 = os.popen(gam_input).read()
                print(result_1)
            question = str("Add "+existing_user_name+" to SWANTON PARA PROFESSIONAL as REGULAR USER?")
            choice = query_yes_no(question, default="yes")
            if choice:
                gam_input= "/Users/Havens/bin/gam/gam update group swantonparaprofessionals@fnwsu.org add member user "+ existing_email
                result_1 = os.popen(gam_input).read()
                print(result_1)
            question = str("Add "+existing_user_name+" to CENTRAL BUILDING as REGULAR USER?")
            choice = query_yes_no(question, default="yes")
            if choice:
                gam_input= "/Users/Havens/bin/gam/gam update group centralstaff@fnwsu.org add member user "+ existing_email
                result_1 = os.popen(gam_input).read()
                print(result_1)
            question = str("Add "+existing_user_name+" to BABCOCK BUILDING as REGULAR USER?")
            choice = query_yes_no(question, default="yes")
            if choice:
                gam_input= "/Users/Havens/bin/gam/gam update group babcockstaff@fnwsu.org add member user "+ existing_email
                result_1 = os.popen(gam_input).read()
                print(result_1)
        ...
        if choice:
            ...
            choice = query_yes_no(question, default="yes")
            if choice:
                gam_input= "/Users/Havens/bin/gam/gam update group swantonprofessionalstaff@fnwsu.org add manager user "+ existing_email
                result_1 = os.popen(gam_input).read()
                print(result_1)
            question = str("Add "+existing_user_name+" to SWANTON PARA PROFESSIONAL as MANAGER?")
            choice = query_yes_no(question, default="yes")
            if choice:
                gam_input= "/Users/Havens/bin/gam/gam update group swantonparaprofessionals@fnwsu.org add manager user "+ existing_email
                result_1 = os.popen(gam_input).read()
                print(result_1)
            question = str("Add "+existing_user_name+" to CENTRAL BUILDING as MANAGER?")
            choice = query_yes_no(question, default="yes")
            if choice:
                gam_input= "/Users/Havens/bin/gam/gam update group centralstaff@fnwsu.org add manager user "+ existing_email
                result_1 = os.popen(gam_input).read()
                print(result_1)
            question = str("Add "+existing_user_name+" to BABCOCK BUILDING as MANAGER?")
            choice = query_yes_no(question, default="yes")
            if choice:
                gam_input= "/Users/Havens/bin/gam/gam update group babcockstaff@fnwsu.org add manager user "+ existing_email
                result_1 = os.popen(gam_input).read()
                print(result_1)
    print("********************")
    ...
    if choice:
        ...
        choice = query_yes_no(question, default="yes")
        if choice:
            gam_input= "/Users/Havens/bin/gam/gam update user "+existing_email+" org '/Swanton-All/Swan Staff-All'"
            result_1 = os.popen(gam_input).read()
            print(result_1)
        else:
            ...
            choice = query_yes_no(question, default="yes")
            if choice:
                gam_input= "/Users/Havens/bin/gam/gam update user "+existing_email+" org '/Swanton-All/Swan Staff-All/Swan Suspended-Staff'"
                result_1 = os.popen(gam_input).read()
                print(result_1)
            else:
                for key in grade_book:
                    ...
                    choice = query_yes_no(question, default="yes")
                    if choice:
                        gam_input= "/Users/Havens/bin/gam/gam update user "+existing_email+" org '/Swanton-All/Swan Students-All/Swan Grade "+str(key)+"-20"+str(grade_book[key])+"'"
                        result_1 = os.popen(gam_input).read()
                        print(result_1)
    print("********************")
    ...
    choice = query_yes_no(question, default="yes")
    if choice:
        gam_input= "/Users/Havens/bin/gam/gam update user "+existing_email+" suspended on"
        result_1 = os.popen(gam_input).read()
        print(result_1)
    else:
        gam_input= "/Users/Havens/bin/gam/gam update user "+existing_email+" suspended off"
        result_1 = os.popen(gam_input).read()
        print(result_1)
